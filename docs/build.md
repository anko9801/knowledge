...
**読んで分かった感覚は、取り出せることとほとんど相関しない。** 定着するのは読んだ
瞬間ではなく、取り出そうとした瞬間である。だから本文の中に、答えを畳んだ問いを置く。
...
問いの作り方で効くのは、**思い出せるかではなく区別が付いているか**を突くこと。
「$sigma$ 加法族の定義は」ではなく「位相は任意個の合併で閉じるのに、
$sigma$ 加法族が可算個までなのはなぜか」と聞く。前者は再認で、後者は再生である。
