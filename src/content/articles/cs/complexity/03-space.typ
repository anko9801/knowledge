...
= 分けられたのは、資源が違うクラスだけだった

#link("/math/logic/8")[数理論理学 第 8 回]で「決定できない問題がある」を示した。
その続きとして、#strong[決定できる問題の中にも階層がある]ことを見たことになる。

手口は最後まで同じだった。対角化で階層を作り、帰着で難しさを移す。
どちらも#link("/math/set-theory/4")[Cantor]から続いている。

#strong[そして、同じ資源のクラスどうしは一つも分けられていない。]

分けられたのは、時間と時間、空間と空間のように、量が違うものだけである。
$upright("P")$ と $upright("NP")$ は同じ多項式時間の枠にいて、片方に検証、
もう片方に発見という違いがあるだけで、そこは対角化が届かない。
$upright("P")$ と $upright("BPP")$ も、$upright("NP")$ と
$upright("co-NP")$ も、同じ理由で開いたままである。

この連載で使った道具は、#strong[量が違えば分けられる、としか言っていない。]
質が違うものを分ける道具は、いまも見つかっていない。
