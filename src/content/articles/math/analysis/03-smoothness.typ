...
#check[
  $C^omega$ は $C^infinity$ より強い条件である。
  強い条件を仮定するほど、言えることは増えるはずである。
  #strong[それなのに多様体論が、わざわざ弱いほうを選ぶのはなぜか。]
][
  #strong[仮定が強いことと、都合がよいことが別だからである。]

  $C^omega$ を仮定すると、一致の定理が付いてくる。ある近傍で $0$ なら全体で $0$、
  つまり#strong[一点の情報が全体を決めてしまう]。強すぎる。

  それが直撃するのが @thm:bump である。ある範囲でだけ $1$、外では $0$ という
  関数は、$C^omega$ では作れない。$0$ の部分があれば全体が $0$ になる。
  作れないと $1$ の分割が作れず、#strong[局所でできることを大域へ持ち上げる手口が、
  丸ごと止まる]。

  多様体の定義も、Stokes の定理の証明も、この手口の上に乗っている。
  だから $C^omega$ を選ぶと、増えた分より失う分のほうが大きい。

  逆に、一点が全体を決めてほしい場面——複素解析、剛性の議論——では
  同じ性質が長所になる。#strong[どちらが強いかではなく、何をしたいかで決まる。]
]
