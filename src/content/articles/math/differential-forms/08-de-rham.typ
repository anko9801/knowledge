...
だが位相の側にも、穴を数える方法がある。しかも#strong[微分をまったく使わない]。
...
#table(
  columns: (auto, 1fr),
  [第 1--4 回], [接ベクトルから外微分まで。計量を使わずに微分を作る],
  [第 5--6 回], [多様体と積分。$n$ 形式だけが積分できる],
  [第 7 回], [コホモロジー。解けるかどうかが位相で決まる],
  [第 8 回], [位相の側と一致し、計量を入れると代表元が一つ選べる],
)
