...
#strong[ただし、区別できるところまでしか区別できない。]

特性類が違えば束も違う、とは言える。逆は言えない。同じ特性類を持つ違う束があり、
実際その現象は $4$ 次元あたりから起きる。曲率から絞り出せる整数は、
束の情報を全部は写していない。

そして写していないぶんが、どれくらいあるのかも分からない。
#strong[取りこぼしの大きさを測る道具が、また別に要る]という形になっていて、
この連載の範囲では手が届かない。

不変量を作る、という営みはたいていこうなる。区別できる例が増えるほど強くなるが、
#strong[「これで全部か」には自分では答えられない。]
