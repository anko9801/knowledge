...
#check[
  第 2 回は $V tilde.equiv V^*$ が自然でないことを強調した。
  @prop:flat-iso は自然な同型だと言う。
  #strong[前言を撤回したのか。]
][
  #strong[撤回していない。前提が一つ増えている。]

  第 2 回で「自然でない」と言ったのは、和とスカラー倍しか無い場では
  同型を作るのに基底を選ぶしかない、という意味だった。
  基底は無数にあり、どれを選んでも同じ資格を持つので、
  #strong[選んだことが結論に残る]。

  @prop:flat-iso は $g$ を使う。$g$ を選んでしまえば、そのあとは基底に触れずに
  同型が書ける。だから「$g$ を固定したうえで自然」であって、
  無条件に自然になったのではない。

  #strong[選択が消えたのではなく、場所が移った。]
  基底から計量へ移すと得なのは、計量のほうは対象が最初から一つ備えていることが
  多く、選択を一度で済ませられるからである。
]
