...
物理では、これが潮汐力である。
地球へ落ちていく二つの物体は、どちらも測地線を進んでいるのに、
互いの距離が変わる。
その変化率が曲率で、これは座標の取り方でどうにもならない。

#strong[「重力は力ではない」と「潮汐力は本物である」は矛盾しない。]
前者は $Gamma$ の話、後者は $R$ の話だからだ。
