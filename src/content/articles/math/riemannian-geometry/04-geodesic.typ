...
= 停留と書いたのであって、最短とは書いていない

まっすぐと最短が一致する、と言った。#strong[正確には、停留する。]

球面の上に二点を取る。二点を通る大円を引くと、弧が二つできる。
短いほうも長いほうも、どちらも測地線である。長いほうは最短ではないし、
少し揺らせば短くできる。それでも $nabla_(dot(gamma)) dot(gamma) = 0$ を満たしている。

#strong[停留は、最小より弱い。] Euler--Lagrange 方程式が言うのは
一階の変分が消えることだけで、二階を見ないと最小かどうかは決まらない。

そして二階を見ると曲率が出る。近い測地線が離れるか近づくかで、
横へ揺らしたときに長さが伸びるか縮むかが決まる。
#strong[最短性がどこまで保つかを決めているのは、曲率のほうである。]

球面のように正の曲率だと、測地線はある距離から先で最短でなくなる。
その距離を曲率の下界から抑えるのが、この連載の最後に出てくる定理である。
