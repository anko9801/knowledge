...
#check[
  $Def(omega)$ は高々可算で、$cal(P)(omega)$ は非可算だった。
  つまり $L$ は、部分集合の圧倒的多数を捨てている。
  #strong[捨てておいて、冪集合の公理が成り立つのはなぜか。]
][
  #strong[公理が要求している「全部」が、中から見た全部だからである。]

  冪集合の公理は「$x$ の部分集合を全部集めた集合がある」と言う。
  この「全部」は無制限の量化子なので、どこまでを見るかが場所に依る。
  $L$ の住人が見えるのは $L$ の中だけで、捨てられた部分集合は
  #strong[存在しないのと同じ]である。

  だから $cal(P)(x) inter L$ を作れば、住人にとってはそれが冪集合になる。
  上の証明がやっているのは、その集合が $L$ のどこかの段階に現れることの確認だけである。

  外から見れば足りていない。だが#strong[足りていないことを言うには外に立つ必要があり]、
  住人は立てない。これが「冪集合は絶対でない」の実物である。
]
