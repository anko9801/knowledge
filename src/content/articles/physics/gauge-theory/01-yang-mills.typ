...
#strong[ここで、各点で別々にずらしてよいことにします。] $alpha$ を定数ではなく
$x$ の関数にします。

$ psi(x) arrow.r e^(i alpha(x)) psi(x) $

#strong[前の段落から出てきたのではありません。] 全体で一斉にずらせることと、
各点で別々にずらせることは、別の主張です。前者しか言っていないところへ、
後者を#strong[足しました。]

そして、これがこの回でいちばん強い仮定です。#strong[相互作用が丸ごと
ここから出ます。] 導いたのではなく、置いたのだと覚えておいてください。
...
偏微分の順序が入れ替えられるからですが、#strong[これは無料ではありません。]
二階の偏微分が連続であることが要ります。そして
#strong[この節でやっているのは、同じ入れ替えが $D_mu$ では成り立たない、
という計算です。] 片方が入れ替えられて片方が入れ替えられない、
その差だけが残ります。
