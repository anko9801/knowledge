...
$  & bold(L)_(s p i n) = frac(1, 4 pi c) integral_(bb(R)^3) thin upright(d) bold(r) bold(E) times bold(A) = frac(1, 4 pi c) integral_(bb(R)^3) thin upright(d) bold(r) (- 1 / c frac(partial bold(A), partial t)) times bold(A)\
 ...
 & = frac(1, 4 pi c) integral frac(thin upright(d) bold(r) thin upright(d) bold(k) thin upright(d) bold(k)', \( 2 pi \)^6) i \| bold(k) \| sum_(j = plus.minus) sum_(j' = plus.minus) \( bold(a)_j \( bold(k) \) times bold(a)_(j') \( bold(k)' \) e^(i \( bold(k) + bold(k)' \) dot.op bold(r))\
 & + bold(a)_j \( bold(k) \) times bold(a)_(j')^(\*) \( bold(k)' \) e^(i \( bold(k) - bold(k)' \) dot.op bold(r)) - bold(a)_j^(\*) \( bold(k) \) times bold(a)_(j') \( bold(k)' \) e^(- i \( bold(k) - bold(k)' \) dot.op bold(r)) - bold(a)_j^(\*) \( bold(k) \) times bold(a)_(j')^(\*) \( bold(k)' \) e^(- i \( bold(k) + bold(k)' \) dot.op bold(r)) \)\
 & = frac(1, 4 pi c) integral frac(thin upright(d) bold(k) thin upright(d) bold(k)', \( 2 pi \)^3) i \| bold(k) \| sum_(j = plus.minus) sum_(j' = plus.minus) \( bold(a)_j \( bold(k) \) times bold(a)_(j') \( bold(k)' \) delta \( bold(k) + bold(k)' \)\
 & + bold(a)_j \( bold(k) \) times bold(a)_(j')^(\*) \( bold(k)' \) delta \( bold(k) - bold(k)' \) - bold(a)_j^(\*) \( bold(k) \) times bold(a)_(j') \( bold(k)' \) delta \( bold(k) - bold(k)' \) + bold(a)_j^(\*) \( bold(k) \) times bold(a)_(j')^(\*) \( bold(k)' \) delta \( bold(k) + bold(k)' \) \)\
