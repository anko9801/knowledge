...
export const concepts: readonly Concept[] = [
  ...
  c('change-of-basis', '基底変換', 'A ↦ P^-1 A P', 'technique', 'math', ['matrix-representation']),
  ...
  c('dual-basis', '双対基底', 'e^i(e_j) = δ^i_j', 'definition', 'math', ['dual-space', 'basis-choice']),
  c('natural-isomorphism', '自然な同型', '選択を要さない同型。V ≅ V^** はそう、V ≅ V^* は違う', 'viewpoint', 'math', ['dual-basis']),
  c('dual-map', '双対写像', 'f: V → W に対し f^*: W^* → V^*。矢印が逆を向く', 'definition', 'math', ['dual-space', 'linear-map']),
  ...
  c('determinant', '行列式', 'Λ^n が 1 次元だから定まる。基底に触れない', 'definition', 'math', ['binomial-dimension', 'linear-map']),
  c('signed-volume', '符号付き体積', '行列式は体積の拡大率', 'viewpoint', 'math', ['determinant']),
  c('orientation', '向き', 'Λ^n ∖ {0} が二つに分かれること', 'definition', 'math', ['determinant']),
  ...
  c('musical-isomorphism', '添字の上げ下げ', '計量が与える V ≅ V^*', 'technique', 'math', ['inner-product', 'natural-isomorphism']),
  ...
  c('volume-form', '体積形式', '計量と向きから決まる Λ^n の元', 'definition', 'math', ['inner-product', 'orientation']),
  c('hodge-star', 'Hodge スター', 'Λ^k ≅ Λ^(n-k)。計量と向きが要る', 'definition', 'math', ['volume-form', 'binomial-dimension']),
  c('self-adjoint', '自己随伴', 'f^† = f。正規直交基底で対称行列', 'definition', 'math', ['adjoint']),
  ...
  c('index-notation', '添字記法', 'ε_ijk と縮約で機械的に計算する', 'technique', 'math', ['grad-div-curl', 'volume-form']),
  c('levi-civita-symbol', 'Levi-Civita 記号', 'ε_ijk。正体は体積形式の成分', 'definition', 'math', ['index-notation', 'volume-form']),
  ...
  c('interior-product', '内部積', '次数を下げる操作 ι_X', 'definition', 'math', ['k-form', 'vector-field']),
  ...
  c('form-basis', '形式の基底', 'dx^i_1 ∧ ⋯ が Λ^k を張る', 'theorem', 'math', ['k-form', 'binomial-dimension']),
  ...
  c('integration-in-rn', 'R^n の領域上の積分', '領域を立方体に分けて足す。多様体も 1 の分割も要らない', 'definition', 'math', ['k-form', 'orientation', 'jacobian-from-wedge']),
  c('boundary-in-rn', '領域の境界と誘導される向き', '外向きを先頭に置く。∂ ∂ = ∅', 'definition', 'math', ['orientation']),
  c('stokes-in-rn', 'Stokes の定理（領域版）', '∫_Ω dω = ∫_∂Ω ω。立方体で示して貼り合わせる', 'theorem', 'math', ['integration-in-rn', 'exterior-derivative', 'boundary-in-rn']),
  ...
  c('stokes-theorem', '一般化された Stokes の定理', '∫_Ω dω = ∫_∂Ω ω。多様体の上で', 'theorem', 'math', ['stokes-in-rn', 'integration-of-forms', 'boundary']),
  ...
  c('de-rham-theorem', 'de Rham の定理', '解析の H^*_dR と位相の H^* が一致する', 'theorem', 'math', ['de-rham-cohomology', 'singular-homology']),
  ...
  c('space-forms', '定曲率空間の分類', 'S^n、R^n、H^n の三つしかない', 'theorem', 'math', ['sectional-curvature']),
  ...
  c('bianchi-identity', 'Bianchi 恒等式', '∇^μ G_μν = 0 が出る', 'theorem', 'math', ['riemann-curvature', 'covariant-derivative']),
  ...
  c('cartan-hadamard', 'Cartan--Hadamard の定理', 'K ≤ 0 なら普遍被覆は R^n', 'theorem', 'math', ['sectional-curvature', 'homotopy']),
  ...
  c('euler-characteristic', 'Euler 標数', 'χ = Σ (-1)^k b_k', 'definition', 'math', ['betti-numbers']),
  ...
  c('ricci-flow', 'Ricci flow', '∂_t g = -2 Ric で計量を均す', 'technique', 'math', ['ricci-tensor', 'bonnet-myers']),
  ...
  c('cumulative-hierarchy', '累積階層', 'V_α を順序数で積み上げる', 'definition', 'math', ['ordinal', 'zfc-axioms']),
  ...
  c('gauge-potential', 'ゲージポテンシャル', 'A_μ。観測量は F だが理論を決めるのは A', 'definition', 'physics', ['lagrangian', 'one-form']),
  ...
  c('aep', '漸近等分割性', '典型列の個数が 2^(nH) に集中する', 'theorem', 'cs', ['entropy', 'law-of-large-numbers']),
  ...
  c('smoothness-class', '滑らかさの階層', 'C^0、C^k、C^∞、解析的。どこまで微分できるか', 'definition', 'math', ['multivariable-calculus']),
  ...
  c('analytic-function', '解析関数', '各点で Taylor 級数が収束して一致する。C^ω', 'definition', 'math', ['power-series', 'smoothness-class']),
  c('identity-theorem', '一致の定理', '解析関数は一点の近傍で決まれば全体が決まる', 'theorem', 'math', ['analytic-function']),
  c('bump-function', '山形関数', 'C^∞ でだけ作れる。1 の分割の材料', 'technique', 'math', ['smoothness-class', 'identity-theorem']),
