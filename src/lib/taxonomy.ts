...
export const series: readonly Series[] = [
  ...
  },
  {
    ...
    title: '計算量理論',
    blurb:
      '「解けるか」の次は「現実的に解けるか」。Turing 機械から計算量クラス、多項式時間帰着を経て、Cook--Levin と Karp の還元の連鎖まで。数理論理学の第 8 回の直接の続き。全 7 回。',
  },
  {
    slug: 'types',
    field: 'cs',
    title: '型と計算',
    blurb:
      '関数の適用と抽象だけで計算を書く。評価戦略、型推論、代数的データ型、そして型が命題でプログラムが証明であること。関数型言語の中身はすべてここに落ちる。全 8 回。',
  },
  {
    slug: 'programs',
    field: 'cs',
    title: 'プログラムの構成',
    blurb:
      '「計算機の構成」の対。人が同時に頭に置ける量は決まっている、という制約を先に置く。goto をやめた理由も、モジュールを隠す理由も、型を付ける理由も、そこから導かれる。負荷は消えず、人と機械のあいだで配分されるだけである。全 8 回。',
  },
  {
    slug: 'information',
    field: 'cs',
    title: '情報理論',
    blurb:
      '圧縮と通信の限界は、経験則ではなく確率論から出る。エントロピーから漸近等分割性、そして符号化定理 2 本まで。測度と確率の連載が前提。全 6 回。',
  },
  {
    slug: 'concurrency',
    field: 'cs',
