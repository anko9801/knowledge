...
export const series: readonly Series[] = [
  ...
  },
  {
    ...
    title: 'プログラムの構成',
    blurb:
      '「計算機の構成」があちらで機械の限界から設計を導くのに対し、こちらは人と時間の限界から導く。goto をやめた理由も、型を付ける理由も、そこから出る。そのうえで、同じ制約から逆の作法が出ることがある。達人どうしが食い違うのは好みではなく、置いている仮定が違うからである。そして全員が「減らせ」と言いながら、数えているものが違う。最後に、何を根拠に決めるかと、測られている数を並べる。作業記憶 4±1、コードのエントロピー 3〜4 ビット、理解に使う時間 58〜70 パーセント、命名の効き目 2 割。全 5 回。',
  },
  {
    slug: 'information',
    field: 'cs',
