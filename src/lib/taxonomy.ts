...
export const series: readonly Series[] = [
  ...
  },
  {
    ...
    title: 'プログラムの構成',
    blurb:
      '「計算機の構成」があちらで機械の限界から設計を導くのに対し、こちらは人と時間の限界から導く。goto をやめた理由も、型を付ける理由も、そこから出る。そのうえで、同じ制約から逆の作法が出ることがある。達人どうしが食い違うのは好みではなく、置いている仮定が違うからである。そして全員が「減らせ」と言いながら、数えているものが違う。全 3 回。',
  },
  {
    slug: 'information',
    field: 'cs',
